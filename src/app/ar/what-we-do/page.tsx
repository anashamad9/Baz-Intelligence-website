...
const title = 'ماذا نفعل | إنتيلجنس لاب'
const description =
  'تعرّف على ما تقدمه إنتيلجنس لاب عبر الاستراتيجية وتنفيذ الأنظمة الذكية والتشغيل والنطاقات المخصصة.'
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'معاينة صفحة ماذا نفعل في إنتيلجنس لاب',
      },
    ],
  },
  twitter: {
